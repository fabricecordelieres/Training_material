...
var outDir=call("ij.Prefs.get", "macroPoitiers2021.outDir", "");
var analysisMode=call("ij.Prefs.get", "macroPoitiers2021.analysisMode", "2D");
var projMeth=newArray("Average Intensity", "Max Intensity", "Min Intensity", "Sum Slices", "Standard Deviation", "Median");
var projMode=call("ij.Prefs.get", "macroPoitiers2021.projMode", "Sum Slices");
...
function GUI(){
	...
	call("ij.Prefs.set", "macroPoitiers2021.outDir", outDir);
	call("ij.Prefs.set", "macroPoitiers2021.analysisMode", analysisMode);
	call("ij.Prefs.set", "macroPoitiers2021.projMode", projMode);
}
