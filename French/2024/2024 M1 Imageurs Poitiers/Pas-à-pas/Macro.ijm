...
//----------------------------------------------------------------------------
function GUI(){
	Dialog.create("Coloc & prox");
	Dialog.addNumber("Median 1 (pixels)", median1);
	Dialog.addNumber("Background subtraction 1 (pixels)", bkgd1);
	Dialog.addNumber("Prominence 1", prominence1);
	Dialog.addNumber("Median 2 (pixels)", median2);
	Dialog.addNumber("Background subtraction 2 (pixels)", bkgd2);
	Dialog.addNumber("Prominence 2", prominence2);
	Dialog.addNumber("Colocalization radius (units)", coloc);
	Dialog.addNumber("Proximity radius (units)", prox);
	Dialog.show();
	
	median1=Dialog.getNumber();
	bkgd1=Dialog.getNumber();
	prominence1=Dialog.getNumber();
	median2=Dialog.getNumber();
